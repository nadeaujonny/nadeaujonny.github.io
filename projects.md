...
<a href="/" class="back-to-projects btn" aria-label="Back to homepage">&larr; Back to Homepage</a>
...
<div class="grid">
  ...
  <div class="col-6">
    <a class="project-card-link excel-card" href="/projects/excel-superstore-analysis/" aria-label="Open Excel project: Sales Dashboard – Superstore Dataset">
      <div class="project-card-content">
        <h2>Excel</h2>
        <h3>Sales Dashboard – Superstore Dataset</h3>
        <p>Interactive dashboard showcasing KPI development, Power Query cleaning, pivot analysis, and executive-ready visuals.</p>
        <div class="project-card-cta">Open project →</div>
      </div>
    </a>
  </div>
  ...
  <div class="col-6">
    <a class="project-card-link tableau-card" href="/projects/tableau-olist-ops-cx/" aria-label="Open Tableau project: Marketplace Ops & Customer Experience (Olist)">
      <div class="project-card-content">
        <h2>Tableau</h2>
