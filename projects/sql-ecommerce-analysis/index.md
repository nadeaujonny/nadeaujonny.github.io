...
<details>
  ...
  <h3>Overview</h3>
  <p>
    This project demonstrates practical SQL skills applied to e-commerce business analysis. Using BigQuery and the public
    <code>thelook_ecommerce</code> dataset, I engineered KPIs, analyzed profitability drivers, evaluated return impact,
    and provided data-driven business recommendations.
  </p>

  <h3>Business Context</h3>
  <p>
    The analysis simulates the role of a data analyst supporting merchandising, operations, and marketing teams at an
    online retail company. Key stakeholders need to understand which products drive profit, where returns create risk,
    and how customer behavior patterns inform growth strategy.
  </p>
